...
| api.podSecurityContext | object | `{"fsGroup":10001,"runAsGroup":10001,"runAsNonRoot":true,"runAsUser":10001,"seccompProfile":{"type":"RuntimeDefault"}}` | Pod security context for API pods (see https://kubernetes.io/docs/tasks/configure-pod-container/security-context/) |
...
| api.securityContext | object | `{"allowPrivilegeEscalation":false,"capabilities":{"drop":["ALL"]},"readOnlyRootFilesystem":true,"runAsNonRoot":true,"runAsUser":10001}` | Container security context for API container (see https://kubernetes.io/docs/tasks/configure-pod-container/security-context/) |
